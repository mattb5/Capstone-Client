...
/***/ function(module, exports, __webpack_require__) {
	...
	var matchEvents = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var matchEvent = __webpack_require__(8);
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signIn(data).done(ui.signInSuccess).then(matchEvent.onGetAllMatches).fail(ui.failure);
	};
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://polar-earth-47067.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetAllMatches = function onGetAllMatches() {
	  api.getAllMatches().done(ui.getMatchesSuccess);
	};

	var onButtonGetAllMatches = function onButtonGetAllMatches(event) {
	  event.preventDefault();
	  api.getAllMatches().done(ui.getMatchesSuccess);
	};
	...
	var onCreateMatch = function onCreateMatch(event) {
	  event.preventDefault();
	  var time = $("#match-time").val();
	  var hostUser = $("#host-name").val();
	  api.createMatch(time, hostUser).done(onGetAllMatches);
	};

	var onOpponentUpdateMatch = function onOpponentUpdateMatch(event) {
	  event.preventDefault();

	  var matchOwner = $(event.target).data("match-owner-id");
	  // console.log("this is matchOwner:", matchOwner);

	  var matchIdToUpdate = $(event.target).data("match-id");
	  // console.log("this is matchIdToUpdate,", matchIdToUpdate)

	  var matchOpponentId = $(event.target).data("match-opponent-id");
	  ...
	  var updatedOpponentName = $(event.target).siblings('input').val();
	  api.opponentUpdateMatch(matchIdToUpdate, updatedOpponentName).done(onGetAllMatches);
	};

	var onGetUserOwnedMatches = function onGetUserOwnedMatches(event) {
	  event.preventDefault();
	  api.getUserOwnedMatches().done(ui.getUserOwnedMatchesSuccess);
	};

	var onUpdateMatchTime = function onUpdateMatchTime(event) {
	  event.preventDefault();
	  var matchIDtoUpdate = $(event.target).data("match-id");
	  // let updatedMatchTime  = $("#update-match-time").val();
	  var updatedMatchTime = $(event.target).siblings('input').val();
	  api.updateMatchTime(matchIDtoUpdate, updatedMatchTime).then(api.getUserOwnedMatches).done(ui.getUserOwnedMatchesSuccess);
	  // .done(onGetAllMatches);
	};

	var onDeleteMatch = function onDeleteMatch(event) {
	  event.preventDefault();
	  var matchIDtoDelete = $(event.target).data("match-id");
	  api.deleteMatch(matchIDtoDelete).then(api.getUserOwnedMatches).done(ui.getUserOwnedMatchesSuccess);
	  // .done(onGetAllMatches);
	};

	var onGetNonHostedMatches = function onGetNonHostedMatches(event) {
	  event.preventDefault();
	  api.getNonHostedMatches().done(ui.getNonHostedMatchesSuccess);
	  // .done(onGetAllMatches);
	};

	var onRemoveOpponentUpdate = function onRemoveOpponentUpdate(event) {
	  event.preventDefault();
	  var matchIdToRemove = $(event.target).data("match-id-remove");
	  api.removeOpponentUpdate(matchIdToRemove).then(api.getNonHostedMatches).done(ui.getNonHostedMatchesSuccess);
	  // .done(onGetAllMatches);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onGetAllMatches: onGetAllMatches
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createMatch = function createMatch(time, hostUser) {
	  return $.ajax({
	    url: app.host + '/matches',
	    method: 'POST',
	    headers: {
	...
	var opponentUpdateMatch = function opponentUpdateMatch(matchIdToUpdate, updatedOpponentName) {
	  return $.ajax({
	...
	var getUserOwnedMatches = function getUserOwnedMatches() {
	  return $.ajax({
	...
	var updateMatchTime = function updateMatchTime(matchIDtoUpdate, updatedMatchTime) {
	  return $.ajax({
	...
	var deleteMatch = function deleteMatch(matchIDtoDelete) {
	  return $.ajax({
	...
	var getNonHostedMatches = function getNonHostedMatches() {
	  return $.ajax({
	...
	var removeOpponentUpdate = function removeOpponentUpdate(matchIdToRemove) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  opponentUpdateMatch: opponentUpdateMatch,
	  getUserOwnedMatches: getUserOwnedMatches,
	  deleteMatch: deleteMatch,
	  updateMatchTime: updateMatchTime,
	  getNonHostedMatches: getNonHostedMatches,
	  removeOpponentUpdate: removeOpponentUpdate
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getMatchesSuccess = function getMatchesSuccess(matches) {
	  $('#matches').html('');
	  var displayAllMatches = __webpack_require__(11);
	...
	var getUserOwnedMatchesSuccess = function getUserOwnedMatchesSuccess(matches) {
	  $('#user-owned-matches').html('');
	  // console.log("this is get matches success in ui");
	  // console.log(matches);
	  var displayUserOwnedMatches = __webpack_require__(31);
	...
	var getNonHostedMatchesSuccess = function getNonHostedMatchesSuccess(matches) {
	  $('#non-hosted-matches').html('');
	  var displayNonHostedMatches = __webpack_require__(32);
	...
	module.exports = {
	  getMatchesSuccess: getMatchesSuccess,
	  getUserOwnedMatchesSuccess: getUserOwnedMatchesSuccess,
	  getNonHostedMatchesSuccess: getNonHostedMatchesSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.opponent : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
	    + "\n      <div class=\"panel-body\">\n        <h5> Match Host:  "
	    + alias4(((helper = (helper = helpers.hostUser || (depth0 != null ? depth0.hostUser : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"hostUser","hash":{},"data":data}) : helper)))
	    + " </h5>\n        <h5> Opponent: "
	    ...
	    + " </h5>\n        <form id=\"patch-match\">\n          <fieldset>\n            <legend class=\"template\">Update Match Opponent </legend>\n             <!-- <input type =\"text\" id=\"update-opponent-name\" placeholder=\"Opponent Name\"> -->\n            <input type =\"text\" class=\"update-opponent-name\" placeholder=\"Opponent Name\">\n            <br></br>\n            <input type=\"submit\" name=\"submit\" value=\"Update Opponent!\" class='updateButtons' data-match-id='"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "' data-match-opponent-id='"
	    + alias4(((helper = (helper = helpers.opponent || (depth0 != null ? depth0.opponent : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent","hash":{},"data":data}) : helper)))
	    + "' data-match-owner-id='"
	    ...
	    + "'>\n          </fieldset>\n        </form>\n        <br></br>\n        <!-- <button class='updateButtons' data-match-id='"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "' data-match-opponent-id='"
	    + alias4(((helper = (helper = helpers.opponent || (depth0 != null ? depth0.opponent : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent","hash":{},"data":data}) : helper)))
	    + "' data-match-owner-id='"
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.matches : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n"
	    ...
	    + " </p>\n        <p> Opponent: "
	    + alias4(((helper = (helper = helpers.opponent || (depth0 != null ? depth0.opponent : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent","hash":{},"data":data}) : helper)))
	    + " </p>\n        <form id=\"patch-match-time\">\n          <fieldset>\n            <legend class=\"template\">Update Match Time </legend>\n            <!-- <input type =\"text\" id=\"update-match-time\" placeholder=\"Update Match Time\"> -->\n            <input type =\"text\" class=\"update-match-time\" placeholder=\"Update Match Time\">\n            <br></br>\n            <input type=\"submit\" name=\"submit\" value=\"Update Match Time!\" class='updateMatchTimeButtons' data-match-id='"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "' data-match-opponent-id='"
	    + alias4(((helper = (helper = helpers.opponent || (depth0 != null ? depth0.opponent : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent","hash":{},"data":data}) : helper)))
	    + "' data-match-owner-id='"
	    + alias4(((helper = (helper = helpers._owner || (depth0 != null ? depth0._owner : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_owner","hash":{},"data":data}) : helper)))
	    + "'>\n          </fieldset>\n        </form>\n        <br></br>\n        <!-- <button class='updateMatchTimeButtons' data-match-id='"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "' data-match-opponent-id='"
	    + alias4(((helper = (helper = helpers.opponent || (depth0 != null ? depth0.opponent : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent","hash":{},"data":data}) : helper)))
	    + "' data-match-owner-id='"
	    + alias4(((helper = (helper = helpers._owner || (depth0 != null ? depth0._owner : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_owner","hash":{},"data":data}) : helper)))
	    + "'>Update</button> -->\n        <button class='deleteButtons' data-match-id='"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "' data-match-opponent-id='"
	    + alias4(((helper = (helper = helpers.opponent || (depth0 != null ? depth0.opponent : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent","hash":{},"data":data}) : helper)))
	    + "' data-match-owner-id='"
	  ...
	  return "    <div class=\"panel panel-success\">\n      <div class=\"panel-heading\">\n        <h3 class=\"panel-title\">Match Time: "
	    + container.escapeExpression(((helper = (helper = helpers.time || (depth0 != null ? depth0.time : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"time","hash":{},"data":data}) : helper)))
	    + "</h3>\n      </div>\n\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    var helper;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n"
	    ...
	    + " </p>\n        <p> Opponent: "
	    + alias4(((helper = (helper = helpers.opponent || (depth0 != null ? depth0.opponent : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent","hash":{},"data":data}) : helper)))
	    + " </p>\n        <!-- <form id=\"patch-match\">\n          <fieldset>\n           <legend>Update Match Opponent </legend>\n            <input type =\"text\" id=\"update-opponent-name\" placeholder=\"Opponent Name\">\n          </fieldset>\n        </form> -->\n        <br></br>\n        <button class='updateRemoveOpponentButtons' data-match-id-remove='"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "' data-match-opponent-id='"
	    + alias4(((helper = (helper = helpers.opponent || (depth0 != null ? depth0.opponent : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent","hash":{},"data":data}) : helper)))
	    + "' data-match-owner-id='"
